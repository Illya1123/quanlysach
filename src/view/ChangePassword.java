...
public class ChangePassword extends javax.swing.JDialog {
    ...
    private Account accHienTai;
    
    public Account getAccHienTai() {
        return accHienTai;
    }
    ...
    public ChangePassword(javax.swing.JFrame parent, boolean modal, Account t) {
        ...
        setLocationRelativeTo(null);
        this.accHienTai = t;
        tenTaiKhoan.setText(this.accHienTai.getFullName());
        email.setText(this.accHienTai.getEmail());
    }
    ...
    private void initComponents() {
        ...
        passNew2nd = new javax.swing.JPasswordField();
            ...
            .addGroup(panel2Layout.createSequentialGroup()
                ...
                .addGroup(panel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addGroup(panel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                        ...
                        .addComponent(passNew2nd, javax.swing.GroupLayout.DEFAULT_SIZE, 321, Short.MAX_VALUE)
        ...
        panel2Layout.setVerticalGroup(
            ...
            .addGroup(panel2Layout.createSequentialGroup()
                ...
                .addComponent(jLabel4)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(passHienTai, javax.swing.GroupLayout.PREFERRED_SIZE, 41, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(2, 2, 2)
                ...
                .addComponent(jLabel6)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(passNew2nd, javax.swing.GroupLayout.PREFERRED_SIZE, 41, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (nameAccount.equals("") || emailAccount.equals("") || passwordAccount.equals("")) {
            ...
            if (isValid(emailAccount)) {
                if (BCrypt.checkpw(passwordAccount, accHienTai.getPassword())) {
                    accHienTai.setFullName(nameAccount);
                    accHienTai.setEmail(emailAccount);
                    AccountDAO.getInstance().update(accHienTai);
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        // TODO add your handling code here:
        boolean check = true;
        String hienTaiPass = passHienTai.getText();
        String passMoi = passNew.getText();
        String passMoi2nd = passNew2nd.getText();

        if (hienTaiPass.length() == 0) {
            check = false;
        ...
        if (check == true) {
            if (BCrypt.checkpw(hienTaiPass, accHienTai.getPassword())) {
                ...
                if (passMoi.length() < 6) {
                    ...
                    if (passMoi.equals(passMoi2nd)) {
                        String pass = BCrypt.hashpw(passNew.getText(), BCrypt.gensalt(12));
                        accHienTai.setPassword(pass);
                        AccountDAO.getInstance().update(accHienTai);
    ...
    private javax.swing.JPasswordField passNew2nd;
